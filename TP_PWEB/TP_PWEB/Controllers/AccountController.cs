...
namespace TP_PWEB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [Authorize (Roles = "Business")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterEmployee(RegisterViewModel modelUser)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    employee.idUser = db.Users.Find(user.Id);
                    employee.idCompany = company;
        ...
        public async Task<ActionResult> RegisterCompany(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //Give the user the choosen role
                    var roleresult = UserManager.AddToRole(user.Id, "Business");

                    Company newCompany = new Company();
                    newCompany.Name = model.CompanyName;

                    AdminBusiness newAdm = new AdminBusiness();
                    newAdm.idCompany = newCompany;
                    newAdm.idUser = db.Users.Find(user.Id);
                    db.Companies.Add(newCompany);
                    db.AdminBusinesses.Add(newAdm);
                    db.SaveChanges();
